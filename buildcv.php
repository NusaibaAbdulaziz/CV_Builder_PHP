	...
	<script type="text/javascript">
		function add_function(name) {
			...
			$(document).ready(function() {
				...
				var fieldHTML = '<div><input class=" form-control" type="text" name="'+name+'[]" value=""/><button type="button"  class="remove_button"><img class="float-left" src="sub.png" width="25"/></div>';
						...
						<div class="col-sm-12">
							...
							<div class="row field_wrapper">
								...
								<div class="col-sm-4 form-group">
									...
									<input type="text" class="form-control" name="General_skills[]">
									<button type="button" onclick="add_function('General_skills')" class="add_button" title="Add field"><img src="add.png" width="30" />
								</div>
